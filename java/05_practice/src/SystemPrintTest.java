...
public class SystemPrintTest {
	...
	public static void main(String[] args) {
		 ...
		 * 출력 하려는 값(지시자)의 수만큼 값을 넣어 줘야 한다.
		 ...
		 * %[0] : 전체 자리수가 지정 되어있을 경우 오른쪽으로 정렬 빈자리는 0으로 채움  ex) %05d, 1000 = 01000
		...
		System.out.printf("%s의 교재는 %,020d 입니다. %n","Java",10000000);
		//Java의 교재는 00000000010,000,000원입니ㅏ.
		System.out.printf("%s의 교재는 %,20d 입니다. %n","Java",10000000);
		//Java의 교재는 		10,000,000원입니다.
		System.out.printf("%s의 교재는 %,-20d원입니다. %n","Java",1000000);
